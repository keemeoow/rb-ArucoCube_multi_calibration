...
#
# 사용법:
#   python capture_rgbd_3cam.py --save_dir ./data/rgbd_capture
#   python capture_rgbd_3cam.py --save_dir ./data/rgbd_capture --intrinsics_dir ./intrinsics
#
# 조작:
#   SPACE : 현재 프레임 저장
...
def main():
    ...
    parser.add_argument("--intrinsics_dir", default="./intrinsics", help="device_map.json 위치")
